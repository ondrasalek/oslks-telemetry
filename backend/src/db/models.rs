...
// ══════════════════════════════════════════════════════════
//  Dashboard-specific models (ported from Leptos frontend)
// ══════════════════════════════════════════════════════════

/// Session user — stored in tower-sessions, returned by /api/auth/me
...
/// Team with member count (for admin listing)
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
...
/// Detailed team member (with user info joined)
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
...
/// Helper for fetching just the role
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
...
/// A single metric data row (e.g. top URL with count)
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
